...
let comidasFavoritas = ["pizza", "escaccia", "locro", "asado"];
...
//console.log("La cantidad de elementos es: " + comidasFavoritas.length);
...
//console.log("El tercer item es: " + comidasFavoritas[2]);
