...
let nuestraImg = document.querySelector("img");
...
const nustroSubTitutlo = document.querySelector("h2");
nustroSubTitutlo.style.color = "yellow";
nustroSubTitutlo.style.backgroundColor = "blue";
